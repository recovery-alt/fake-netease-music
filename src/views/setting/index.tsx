...
const Setting: React.FC = () => {
  ...
  return (
    <div className="setting">
      <section className="setting__item">
      ...
      <section className="setting__item">
        ...
        <div className="setting__common">
          <div className="setting__label">动画:</div>
          <Checkbox>
            禁用动画效果 <span className="setting__sub">(减少部分资源占用)</span>
          </Checkbox>
          <div className="setting__label">
            播放列表: <span className="setting__sub">单曲、节目</span>
          </div>
          <Radio.Group>
            <Space direction="vertical">
              <Radio>
                双击播放单曲时，用当前单曲所在的歌曲列表替换播放列表
                <span className="setting__sub">节目同理</span>
              </Radio>
              <Radio>
          ...
          <div className="setting__label">播放歌曲时:</div>
      ...
      <section className="setting__item">
        ...
        <div className="setting__label">
          私信: <span className="setting__sub">接收私信提醒</span>
        </div>
        <Radio.Group>
          <Space direction="vertical">
            <Radio>所有人</Radio>
        ...
        <div className="setting__label">通知:</div>
        <Checkbox>歌单被收藏</Checkbox>
        <Checkbox>收到赞</Checkbox>
        <Checkbox>新粉丝</Checkbox>
        <div className="setting__label">我的听歌排行:</div>
        <Radio.Group>
          <Space direction="vertical">
            <Radio>所有人可见</Radio>
            <Radio>我关注的人可见</Radio>
        ...
        <div className="setting__label">黑名设置:</div>
        <div>
          我的黑名单 <button>查看</button>
        </div>
        <div className="setting__label">个性化服务:</div>
        <Radio.Group>
          <Space direction="vertical">
            <Radio>开启</Radio>
      ...
      <section className="setting__item">
        ...
        <div className="setting__shortcuts-wrapper">
          <div className="setting__shortcuts">
            <div>功能说明</div>
            <div>快捷键</div>
            <div>全局快捷键</div>
          </div>
          {shortcuts.map((item, i) => (
            <div key={i} className="setting__shortcuts">
        ...
        <Checkbox>
          <div className="setting__checkbox">
            启用全局快捷键<span className="setting__sub">云音乐在后台时也能相应</span>
            <button>恢复默认</button>
          </div>
        </Checkbox>
        <div className="setting__checkbox">
      ...
      <section className="setting__item">
        ...
        <div>
          <div className="setting__label">音质选择:</div>
          <div>
            试听:
            <Radio.Group>
          ...
          <div className="setting__label">缓存设置:</div>
          <div className="setting__cache">
            <span>缓存最大占用</span>
            <Slider />
            <span>1G</span>
            <button>清除缓存</button>
        ...
        <div className="setting__label">音乐命名格式:</div>
        <Radio.Group>
          <Space direction="vertical">
        ...
        <div className="setting__label">文件只能分类:</div>
        <Radio.Group>
          <Space direction="vertical">
      ...
      <section className="setting__item">
        ...
        <div className="setting__lyric">
          <div className="setting__label">类型:</div>
          <Radio.Group>
            <Space direction="vertical">
          ...
          <div className="setting__label">启用:</div>
